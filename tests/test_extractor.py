import unittest
from extractor.extractor import extract_job_details_from_text

class TestExtractor(unittest.TestCase):

    def test_salary_extraction(self):
        text = "You will receive a monthly stipend of INR 20,000."
        result = extract_job_details_from_text(text)
...
# This test suite uses unittest to validate the functionality of the extractor module.
# It includes tests for salary extraction, perk detection, and benefit detection.
